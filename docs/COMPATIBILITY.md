...
**M2 里程碑：** 至 **M2bn** 已含 CONFIG Godis 自有项、CLIENT qbuf-free、MEMORY STATS 浅键、OBJECT listpack/intset、Lua setresp SMEMBERS/CONFIG 形 map 等。仍延期：集群 CRC16/MOVED、HLL 互通、真 HNSW、完整 FAILOVER、精确 `used_memory`、FUNCTION DUMP 官方互通、MIGRATE 等（见计划文档）。
