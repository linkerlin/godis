...
**最后更新：** 2026-08-17（第六十三批：VECTOR_RANGE 属性白名单对齐 Redis 8.10；FT.AGGREGATE ADDSCORES；R4-1 扩至 **314**；对照 Redis **8.10** sidecar；远期仍 **7**：jemalloc / gossip / 模块 RDB·DUMP / FUNCTION DUMP 互通 / 完整 BM25·KNN·DIALECT / R4-1 全量 / R4-2）
