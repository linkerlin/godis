...
**M2 里程碑：** 至 **M2bm** 已含 INFO memory 浅层、MEMORY STATS 键名、OBJECT embstr、FT DEFAULT_DIALECT/AGGREGATE 封顶、Lua setresp 入口等。仍延期：集群 CRC16/MOVED、HLL 互通、真 HNSW、完整 FAILOVER、精确 `used_memory`、FUNCTION DUMP 官方互通、MIGRATE 等（见计划文档）。
