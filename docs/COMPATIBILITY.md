...
**最后更新：** 2026-08-17（第八十六批：FT.CONFIG 校验文案 + **ON_TIMEOUT RETURN-STRICT** + FT._LIST 字典序 + ALIAS/DICT arity（对照 Redis **8.10**）+ R4-1 扩至 **914**；远期仍 **7**：jemalloc / gossip / 模块 RDB·DUMP / FUNCTION DUMP 互通 / 完整 BM25·KNN·DIALECT / R4-1 全量 / R4-2）
