...
**最后更新：** 2026-08-17（第八十一批：FT **GEOFILTER/FILTER/SLOP/EXPANDER/BM25STD_TANH_FACTOR** + AGGREGATE **APPLY/GROUPBY/FILTER** 文案与边界（对照 Redis **8.x**）+ R4-1 扩至 **680**；远期仍 **7**：jemalloc / gossip / 模块 RDB·DUMP / FUNCTION DUMP 互通 / 完整 BM25·KNN·DIALECT / R4-1 全量 / R4-2）
