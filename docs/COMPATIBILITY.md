...
**仍延期 / 非本轮：** 集群 CRC16/MOVED/ASK；HSCAN/ZSCAN 第二段官方仍为 Array；jemalloc 级 `used_memory`；Vector Q8/BIN；完整 BM25/KNN；FUNCTION DUMP 官方互通。
...
**最后更新：** 2026-08-09（补 `CF.INFO` Map；R2-2/3/4 标为已实现）
