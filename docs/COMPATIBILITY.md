...
**最后更新：** 2026-08-15（第二十七批可关闭：CONFIG hz/slowlog/listpack/notify；JSON.STRAPPEND；CMS.MERGE/TOPK.COUNT；XSETID；FT.SUGADD；REPLICAOF port；TIME/DBSIZE/LASTSAVE/COMMAND COUNT；BGSAVE；LATENCY GRAPH；对照 Redis **8.10.0**；远期仍 **7**）
