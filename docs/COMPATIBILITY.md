...
**最后更新：** 2026-08-15（第二十九批可关闭：CONFIG lazyfree/jemalloc/announce-port；MODULE/OBJECT/BGREWRITEAOF arity；FUNCTION LIST；ACL LOG/CAT；WAITAOF；XGROUP NOGROUP；对照 Redis **8.10.0**；远期仍 **7**）
