...
### 复制与客户端连接
- REPLICAOF、SLAVEOF、PSYNC、WAITAOF
- FAILOVER（真实协调切换：TO/FORCE/ABORT/TIMEOUT，见 docs/FAILOVER_DESIGN.md）
- AUTH、HELLO、PING、SELECT、SWAPDB
- CLIENT LIST、CLIENT SETNAME、CLIENT TRACKING、CLIENT PAUSE/UNPAUSE、CLIENT KILL
...
### 诊断
- DEBUG SET-ACTIVE-EXPIRE、DEBUG DIGEST、DEBUG DIGEST-VALUE、DEBUG CHANGE-REPL-ID、DEBUG OBJECT、DEBUG SLEEP、DEBUG STRINGMATCH-LEN
