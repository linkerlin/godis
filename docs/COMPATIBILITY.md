...
**最后更新：** 2026-08-15（第三十批可关闭：CONFIG bool/integer/sanitize；ACL/PUBSUB/REPLICAOF arity；CLIENT CACHING；TS.CREATERULE；XGROUP SETID/XACK；JSON.OBJLEN；对照 Redis **8.10.0**；远期仍 **7**）
