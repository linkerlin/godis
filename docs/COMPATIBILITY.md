...
**最后更新：** 2026-08-17（第七十六批：APPLY **timefmt** 纠偏 **`%P`/`%k`/`%l`**（对照 Redis **8.6**；未知仍 Null）+ R4-1 扩至 **508**；远期仍 **7**：jemalloc / gossip / 模块 RDB·DUMP / FUNCTION DUMP 互通 / 完整 BM25·KNN·DIALECT / R4-1 全量 / R4-2）
