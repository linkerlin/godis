...
**M2 里程碑：** 至 **M2ax** 已含 COMMAND LIST、GETRANGE/OBJECT/Lua reply、proto-max-bulk-len 等。仍延期：集群 CRC16/MOVED、HLL 互通、真 HNSW、完整 FAILOVER、精确 `used_memory`、FUNCTION DUMP 官方互通、MIGRATE 等（见计划文档）。
