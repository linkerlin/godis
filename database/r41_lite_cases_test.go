...
func TestR41LiteCaseExpectations(t *testing.T) {
	...
	asserts.AssertStatusReply(t, testDB.Exec(nil, utils.ToCmdLine("SET", "b74a", "ohmytext")), "OK")
	asserts.AssertStatusReply(t, testDB.Exec(nil, utils.ToCmdLine("SET", "b74b", "mynewtext")), "OK")
	asserts.AssertIntReply(t, testDB.Exec(nil, utils.ToCmdLine("LCS", "b74a", "b74b", "LEN")), 6)
	asserts.AssertIntReply(t, testDB.Exec(nil, utils.ToCmdLine("ZADD", "b74z", "1", "a", "2", "b")), 2)
	asserts.AssertMultiBulkReply(t, testDB.Exec(nil, utils.ToCmdLine("ZRANGE", "b74z", "0", "0", "WITHSCORES")), []string{"a", "1"})
	asserts.AssertMultiBulkReply(t, testDB.Exec(nil, utils.ToCmdLine("ZREVRANGE", "b74z", "0", "0", "WITHSCORES")), []string{"b", "2"})
	asserts.AssertStatusReply(t, testDB.Exec(nil, utils.ToCmdLine("SET", "b74e", "v")), "OK")
	asserts.AssertIntReply(t, testDB.Exec(nil, utils.ToCmdLine("EXPIRE", "b74e", "120", "NX")), 1)
	asserts.AssertIntReply(t, testDB.Exec(nil, utils.ToCmdLine("EXPIRE", "b74e", "120", "NX")), 0)
	asserts.AssertIntReply(t, testDB.Exec(nil, utils.ToCmdLine("SADD", "b74s", "a")), 1)
	asserts.AssertIntReply(t, testDB.Exec(nil, utils.ToCmdLine("SISMEMBER", "b74s", "a")), 1)
	asserts.AssertIntReply(t, testDB.Exec(nil, utils.ToCmdLine("SISMEMBER", "b74s", "b")), 0)
	asserts.AssertStatusReply(t, testDB.Exec(nil, utils.ToCmdLine("SET", "b74str", "ohmytext")), "OK")
	asserts.AssertBulkReply(t, testDB.Exec(nil, utils.ToCmdLine("GETRANGE", "b74str", "-4", "-1")), "text")
}
