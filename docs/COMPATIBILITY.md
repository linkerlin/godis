...
**最后更新：** 2026-08-17（第七十九批：FT **WITHCURSOR COUNT** 文案 + **SCORER** 校验 + **TAGVALS** 字段类型（对照 Redis **8.6/8.x**）+ R4-1 扩至 **595**；远期仍 **7**：jemalloc / gossip / 模块 RDB·DUMP / FUNCTION DUMP 互通 / 完整 BM25·KNN·DIALECT / R4-1 全量 / R4-2）
