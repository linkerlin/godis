...
**最后更新：** 2026-08-17（第八十批：FT **LANGUAGE**/选项文案 + **INKEYS 0** + **WITHSORTKEYS `#`/`$`** + **CURSOR** 文案（对照 Redis **8.10**）+ R4-1 扩至 **633**；远期仍 **7**：jemalloc / gossip / 模块 RDB·DUMP / FUNCTION DUMP 互通 / 完整 BM25·KNN·DIALECT / R4-1 全量 / R4-2）
