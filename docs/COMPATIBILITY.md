...
**M2 里程碑：** 至 **M2bz** 已含 SCRIPT EXISTS 整数数组、HELLO proto/id 整数、INFO git_sha1/supervised、jemalloc/lazyfree 桩、Lua ZUNION 无 scores→set 等。仍延期：集群 CRC16/MOVED、HLL 互通、真 HNSW、完整 FAILOVER、精确 `used_memory`、FUNCTION DUMP 官方互通、MIGRATE 等（见计划文档）。
