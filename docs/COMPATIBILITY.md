...
**最后更新：** 2026-08-15（第二十八批可关闭：CONFIG bool/integer；MONITOR/SAVE/MEMORY/LATENCY/MODULE/PUBSUB arity；TS rule 缺键；XCLAIM/XAUTOCLAIM/XINFO NOGROUP；FT.ALIASDEL；对照 Redis **8.10.0**；远期仍 **7**）
