...
**M2 里程碑：** 至 **M2ca** 已含 Lua SPOP count→set、lazyfree-user/aof-load CONFIG 桩、INFO build_id/gcc/monotonic、SLOWLOG client name、ACL DRYRUN UNSUBSCRIBE 等。仍延期：集群 CRC16/MOVED、HLL 互通、真 HNSW、完整 FAILOVER、精确 `used_memory`、FUNCTION DUMP 官方互通、MIGRATE 等（见计划文档）。
