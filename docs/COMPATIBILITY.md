...
**M2 里程碑：** 至 **M2bb** 已含 FT INFIELDS/SUMMARIZE/短语邻近、JSON `$` 封装、Lua REDIS_VERSION/REPL_*、protected-mode 等。仍延期：集群 CRC16/MOVED、HLL 互通、真 HNSW、完整 FAILOVER、精确 `used_memory`、FUNCTION DUMP 官方互通、MIGRATE 等（见计划文档）。
