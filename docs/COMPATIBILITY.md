...
**M2 里程碑：** 至 **M2bt** 已含 COMMAND GETKEYSANDFLAGS、INFO everything/modules/latency、replica-announce+activedefrag、Lua XRANGE map、errorstats 真计数等。仍延期：集群 CRC16/MOVED、HLL 互通、真 HNSW、完整 FAILOVER、精确 `used_memory`、FUNCTION DUMP 官方互通、MIGRATE 等（见计划文档）。
