...
**M2 里程碑：** 至 **M2bd** 已含 CONFIG loglevel 真过滤、FT.EXPLAIN/PROFILE 增强、Lua error_handler 回调、CLIENT LIST user= 等。仍延期：集群 CRC16/MOVED、HLL 互通、真 HNSW、完整 FAILOVER、精确 `used_memory`、FUNCTION DUMP 官方互通、MIGRATE 等（见计划文档）。
