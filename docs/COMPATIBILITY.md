...
**最后更新：** 2026-08-17（第八十二批：FT **SEARCH_ARG_UNRECOGNIZED**/裸 WITHCOUNT + CREATE **STOPWORDS/TEMPORARY**（TEMPORARY 0 立即无索引；对照 Redis **8.10**）+ R4-1 扩至 **739**；远期仍 **7**：jemalloc / gossip / 模块 RDB·DUMP / FUNCTION DUMP 互通 / 完整 BM25·KNN·DIALECT / R4-1 全量 / R4-2）
