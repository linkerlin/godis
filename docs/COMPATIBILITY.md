...
**最后更新：** 2026-08-17（第八十五批：FT.ALTER **SCHEMA ADD** 文案 + **SKIPINITIALSCAN** + DROPINDEX **Unknown argument** + SYNADD 移除文案 + SYNUPDATE/SYNDUMP 缺索引（对照 Redis **8.10**）+ R4-1 扩至 **897**；远期仍 **7**：jemalloc / gossip / 模块 RDB·DUMP / FUNCTION DUMP 互通 / 完整 BM25·KNN·DIALECT / R4-1 全量 / R4-2）
