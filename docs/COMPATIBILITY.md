...
**最后更新：** 2026-08-17（第八十批：FT **LANGUAGE** + **RETURN/INKEYS/LOAD/PARAMS/HIGHLIGHT** 文案与边界 + **CURSOR READ COUNT**（对照 Redis **8.10**）+ R4-1 扩至 **630**；远期仍 **7**：jemalloc / gossip / 模块 RDB·DUMP / FUNCTION DUMP 互通 / 完整 BM25·KNN·DIALECT / R4-1 全量 / R4-2）
