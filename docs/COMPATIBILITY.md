...
**M2 里程碑：** 至 **M2bv** 已含 CLIENT LIST USER、OBJECT FREQ 需 LFU、ACL CAT @fast/@slow/@blocking、WAITAOF 桩、FUNCTION STATS 嵌套回复等。仍延期：集群 CRC16/MOVED、HLL 互通、真 HNSW、完整 FAILOVER、精确 `used_memory`、FUNCTION DUMP 官方互通、MIGRATE 等（见计划文档）。
