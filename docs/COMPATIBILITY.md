...
**最后更新：** 2026-08-17（第八十三批：FT.CREATE **PREFIX/ON/LANGUAGE/SCORE/INDEXALL/FILTER**/无 SCHEMA + **TIMEOUT** `SEARCH_PARSE_ARGS` 前缀（对照 Redis **8.10**）+ R4-1 扩至 **788**；远期仍 **7**：jemalloc / gossip / 模块 RDB·DUMP / FUNCTION DUMP 互通 / 完整 BM25·KNN·DIALECT / R4-1 全量 / R4-2）
