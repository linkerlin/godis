...
**M2 里程碑：** 至 **M2bc** 已含 FT AGGREGATE 小选项、JSON `$` CLEAR/TOGGLE、INFO redis_mode、CLIENT LIST ssub、Lua set_error_handler 等。仍延期：集群 CRC16/MOVED、HLL 互通、真 HNSW、完整 FAILOVER、精确 `used_memory`、FUNCTION DUMP 官方互通、MIGRATE 等（见计划文档）。
